<div class="row" id="row-video-0">
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" name="video[0][link]" value="{{ old("video.0.link") }}" id="video_link_0" required>
    </div>
    <div class="col-md-2 mb-3">
        <label for="video_sequence_number_0" class="form-label fw-bold">{{ __('messages.sequence_number') }}</label>
        <input type="number" class="form-control" name="video[0][sequence_number]" min="1" value="{{ old("video.0.sequence_number") }}" id="video_sequence_number_0" required>
    </div>
    <div class="col-md-2 mb-3">
